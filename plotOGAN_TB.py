...
df_VLLb['avg_Validation LL/Sample'] = df_VLLb[['Validation LL/Sample: G2(testset)-->(E1,G1)','Validation LL/Sample: G1(testset)-->(E2,G2)']].sum(axis=1)/2
...
df_VLLe['Validation LL/epoch: avg(G1+G2) (bits/dim)']=df_VLLb.groupby(np.arange(len(df_VLLb))//100).mean()['avg_Validation LL/Sample']/(math.log(2)*nc*(imageSize**2))
df_VLLe['Validation LL/epoch: min(G1+G2) (bits/dim)']=df_VLLb.groupby(np.arange(len(df_VLLb))//100).mean()['min_Validation LL/Sample']/(math.log(2)*nc*(imageSize**2))
df_VLLe['Validation LL/epoch G1(bits/dim)']=df_VLLb.groupby(np.arange(len(df_VLLb))//100).mean()['Validation LL/Sample: G2(testset)-->(E1,G1)']/(math.log(2)*nc*(imageSize**2))
df_VLLe['Validation LL/epoch G2(bits/dim)']=df_VLLb.groupby(np.arange(len(df_VLLb))//100).mean()['Validation LL/Sample: G1(testset)-->(E2,G2)']/(math.log(2)*nc*(imageSize**2))
...
df_VLLe['Validation LL/epoch: min(G1+G2) (bits/dim)'].plot(kind='line', color='r', ax=ax, linewidth=2, label='min(OGAN-G1,OGAN-G2)')
df_VLLe['Validation LL/epoch: avg(G1+G2) (bits/dim)'].plot(kind='line', color='r', ax=ax, linestyle='--', linewidth=2, label='avg(OGAN-G1,OGAN-G2)')
